...
path1 = "F:/Temp/after/yacht_head.bmp" #头文件隐写后的图片路径
path2 = "F:/Temp/after/yacht_eof.bmp" #尾部隐写后的图片路径
path3 = "F:/Temp/after/yacht_lsb.bmp" #数据区隐写后的图片路径
txtmax = 'F:/Temp/info/txtmax.txt'#大文件路径
txtmin = 'F:/Temp/info/txtmin.txt'#小文件路径
txtlsb = 'F:/Temp/info/txtlsb.txt'
...
def lsb_hide():
    ...
    while True:
        ...
        print("")
        if choice == 1:
            hide_lsb(mode='sequential')
        elif choice == 2:
            hide_lsb(mode='random')
        elif choice == 3:
            break
        else:
            print("请重新输入")
